...
export default function LandingPage() {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: 'Set up user access levels and assign roles to team members.',
    },
    {
      number: '04',
      title: 'Monitor & Report',
      description: 'Track compliance and generate insightful reports on your policies.',
    },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl sm:text-2xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
              Streamline policy management, ensure compliance, and maintain control across your entire organization with our powerful platform.
            </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Everything you need to manage policies effectively and maintain organizational compliance.
            </p>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-indigo-600 dark:bg-indigo-500">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-indigo-100 mb-8 max-w-2xl mx-auto">
            Join thousands of organizations that trust us to manage their policies efficiently and securely.
          </p>
          <Link
            href="/auth/signup"
